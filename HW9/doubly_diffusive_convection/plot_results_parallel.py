...
color_map = [('RdYlBu', 'diverging', 11), ('RdYlBu', 'diverging', 11), ('RdYlBu', 'diverging', 11), ('BuPu', 'sequential', 9)]
color_map = [('RdYlBu', 'diverging', 11), ('RdYlBu', 'diverging', 11), ('BuPu', 'sequential', 9)]

reverse_color_map = [True, True, True, True]
float_this_scale = [False, False, False, False]

reverse_color_map = [False, True, True]
float_this_scale = [False, False, False]
